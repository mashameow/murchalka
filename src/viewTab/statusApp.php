...
$statusAppView = "SELECT * FROM statusApp";
$statusAppView_result = mysqli_query($db, $statusAppView);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	<div class="container">
		<h2 class="admin_title">Все возможные статусы заявок</h2>
		<table>
			<tr>
				<th class="popup__block-text">ID_statusApp</th>
				<th class="popup__block-text">Название статуса</th>
			</tr>
			<?php while ($row = mysqli_fetch_assoc($statusAppView_result)) { ?>
				<tr>
